...
This page is both a documentation example and a valid Provedown document. It
shows a more realistic pattern: import Python standard-library modules, read a
data file next to the report, compute summary values, and assert those values in
the prose.
